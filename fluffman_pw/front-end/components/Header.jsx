            ...
            <nav className="w-100 px-5 py-3 d-flex justify-content-between align-items-center bg-body-tertiary">
               ...
               {/* Loghi */}
                ...
                <ul className="d-none d-lg-flex list-unstyled m-0 gap-4 align-items-center nav-list-desktop">
                    ...
                    <li>
                        <button className="p-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">
                ...
                <div className="d-lg-none d-flex jsutify-content-center align-items-center gap-3">
                    ...
                    <button className="d-block d-lg-none offcanvas-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">
                        <i className="fa-solid fa-magnifying-glass"></i>
                    </button>
