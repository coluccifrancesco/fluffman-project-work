...
export default function Header() {
    return <header className='position-sticky top-0 z-2 w-100'>

        <div className='upper-header d-flex justify-content-center align-items-center'>
            <p className='m-0 p-1'>Spedizione gratuita a partire da €19,99 <i className="fa-solid fa-truck-fast ps-2"></i></p>
        </div>
        ...
        <nav className="w-100 px-4 py-3 d-flex justify-content-between align-items-center bg-body-tertiary">
            ...
            <div>
                {/* Logo pagina estesa */}
                <Link to={'/'}><img src='Logo3.png' className='header-logo-fromLg d-none d-lg-block' /></Link>

                {/* Logo pagina ridotta */}
                <Link to={'/'}><img src='Logo1.png' className='header-logo-belowLg d-block d-lg-none' /></Link>
            </div>
            ...
            <div className="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabIndex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
                <div className="offcanvas-header">
                    <Link to={'/'}><img src='DogFaceLogo.png' className='header-logo-belowLg d-block d-lg-none' id="offcanvasScrollingLabel" /></Link>
