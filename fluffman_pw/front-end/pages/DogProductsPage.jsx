    ...
    return (
        <>
            <div className="m-2 p-2">
                ...
                <p>La nostra ampia scelta di prodotti per cani, propone prodotti di altissima qualità per prenderti cura al meglio del tuo amico a 4 zampe</p>
            </div>
            ...
            {/* Sezione accessori */}
            <div className="m-2 p-2">
                <h2>Giochi, collari, cucce, tutto, ma proprio tutto ciò che serve per il tuo cane</h2>
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-6 g-4">
                    {[...Array(6)].map((_, idx) => (
                        <CardItem key={idx} title={`Scelta ${idx + 1}`} />
                    ))}
